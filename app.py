...
# رابط الصورة المباشر من مستودعك (Raw Link)
LOGO_URL = "https://raw.githubusercontent.com/hmmodtech/mediatracker/main/ACF%20logo.png"
...
# --- الهيدر (الشعار على اليسار والعنوان في المنتصف) ---
header_left, header_mid, header_right = st.columns([1, 2, 1])

with header_left:
    # عرض الشعار من رابط GitHub الخاص بك مباشرة
...
with header_right:
    # مساحة فارغة للمحافظة على التوازن أو لإضافة نص مستقبلاً
    st.write("")
...
with st.sidebar:
    ...
    search_q = st.text_input("🔍 Filter News:", placeholder="Search keywords...")
    st.divider()
